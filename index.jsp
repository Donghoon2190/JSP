...
<html>
	...
	<title>New Folder &mdash; Free Website Template, Free HTML5 Template by GetTemplates.co</title>
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.jsp">New Folder <em>.</em></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>						
						...
						<li class="btn-cta"><a href="Loginindex.jsp"><span>Sign in</span></a></li>
										...
										<div class="tab-content-inner active" data-content="signup">
											...
											<form action="regControll" method="post">
												<div class="row form-group">
													<div class="col-md-12">
														<label>ID</label>
														<input type="text" id="ID" class="form-control" required autofocus placeholder="type your ID" name="id">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label>Password</label>
														<input type="Password" id="Password" class="form-control" required placeholder="type your PW" name="pwd">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label>NickName</label>
														<input type="text" id="NickName" class="form-control" required placeholder="type your NickName" name="nickname">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label>Address</label>
														<input type="text" id="Address" class="form-control" required placeholder="type your Address" name="add">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
	...
	<div id="contentsVS" class="gtco-section">
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6" style="padding-bottom: 10vw;">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/krfd11.jpeg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2 class="cursive-font primary-color" style="font-size: 3rem;">Korean Food</h2>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/asfd11.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2 class="cursive-font primary-color" style="font-size: 3rem;">Asian Food</h2>
							<p>Thai & Japanese</p>							
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/chfd.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2 class="cursive-font primary-color" style="font-size: 3rem;">Chinese Food</h2>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/wtfd.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2 class="cursive-font primary-color" style="font-size: 3rem;">Western Food</h2>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/ftfd5.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2 class="cursive-font primary-color" style="font-size: 3rem;">Fast Food</h2>
							<p>Enjoy various Korean foods</p>
							<!-- <p><span class="price cursive-font">$8.99</span></p> -->
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/cfdt2.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2 class="cursive-font primary-color" style="font-size: 3rem;">Coffee & Dessert</h2>
							<p>Enjoy various Korean foods</p>
							<!-- <p><span class="price cursive-font">$8.99</span></p> -->
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					...
					<p>We have been always worried
						What should we eat today?</br>
						But from now on,
						Don't worry about it anymore</p>
						<p> Just do eat !</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							...
							<a href="#contentsVS"><i class="ti-face-smile"></i></a>
						</span>
						<h3>Is eat fun?	It is fun!</h3>
						<p>Try ”VS game” !</br>
							If choosing the menu make you stressed out!</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							<a href="#contentsVS"><i class="ti-thought"></i></a>
						</span>
						<h3>Where are you?</h3>
						<p>
							Click the 'recommend' and then look around!</br>
							You'll find a good place that you didn't know.
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							<a href="#gtco-subscribe"><i class="ti-truck"></i></a>
						</span>
						<h3>You are lucky !</h3>
						<p>
							As soon as press the ”APPLY”</br>
							You can get something lucky!
						</p>
					</div>
				</div>
	...
	<footer id="gtco-footer" role="contentinfo" style="background-image: url(images/img_bg_1.jpg)" data-stellar-background-ratio="0.5">
		...
		<div class="gtco-container">
			<div class="row row-pb-md">
				...
				<div class="col-md-12 text-center">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
							...
							<li><a href="#"><i class="icon-mail2"></i> moonsj6894@naver.com</a></li>
							<li><a href="#"><i class="icon-chat"></i> Kakako</a></li>
						</ul>
					</div>
					<div class="gtco-widget">
						<h3>Get Social</h3>
				...
				Made by <i class="fa fa-love"></i><a href="https://bootstrapthemes.co">New Folder</a>
				</div>
