      ...
      <div class="row">
        ...
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
         <form action="SignControll" method="post" name="formN">
              <div class="col-12 col-md-9 mb-2 mb-md-0" style="float: left;">
                <input type="text" id="id" name="id" class="form-control form-control-lg" placeholder="Enter your Id" style="margin-bottom: 20px" required>
 	              </div> 
 	               <div style="width: 2000px; text-align: left;"> <span id="confirmId"></span></div>
               <div class="col-12 col-md-3" style="margin-left: 50%;">
               <input type="button" onclick="CheckId()" class="btn btn-block btn-lg btn-primary" value="Check Id" required>
              </div> <br>
                ...
                <span id="confirmPw"></span>
                 <br>
                 <input type="password"  id="pass2" onkeyup="CheckPw()" id="Checkpass" class="form-control form-control-lg" placeholder="Enter your Passward">
                 <span id="result"></span>
              </div><br>
              <div class="col-12 col-md-9 mb-2 mb-md-0"> 
