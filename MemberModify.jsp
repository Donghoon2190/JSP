											...
											<form action="UserModify">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="Password" id="Password1" class="form-control" required placeholder="Change your PW" name="pass">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label>NickName</label>
														<input type="text" id="NickName1" class="form-control" required placeholder="${nickname }" name="nickname">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label>Address</label>
														<input type="text" id="Address1" class="form-control" required placeholder="${add }" name="add">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
