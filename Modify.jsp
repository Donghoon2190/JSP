				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-6 animate-box">
							<h3>Modify</h3>
							<form action="communityMod" method="post">
							...
							<div class="col-md-12">
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="sr-only" for="email">CO_TITLE</label>
										<input type="text" id="email" class="form-control" placeholder="CO_TITLE" name="title">
									</div>
								</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<textarea style="resize: none" name="content" id="message" cols="30" rows="10"
											class="form-control" placeholder="CO_COMMENT"></textarea>
									</div>
								</div><br>
